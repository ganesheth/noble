...
var Adv_Scan_Interval = 0x10;
var Adv_Scan_Window = 0x10;
var Adv_Scan_Type = 0x01; // 0x01 = Active, 0x00 = Passive
...
Hci.prototype.overrideScanParameters = function(interval, window, type){
  Adv_Scan_Interval = interval;
  Adv_Scan_Window = window;
  Adv_Scan_Type = type;
};
...
Hci.prototype.setScanParameters = function() {
  ...
  // data
  cmd.writeUInt8(Adv_Scan_Type, 4); // type: 0 -> passive, 1 -> active
  cmd.writeUInt16LE(Adv_Scan_Interval, 5); // internal, ms * 1.6
  cmd.writeUInt16LE(Adv_Scan_Window, 7); // window, ms * 1.6
